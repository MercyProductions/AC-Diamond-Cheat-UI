...
namespace ImGui
{
    ...
    IMGUI_API bool          Defaults(const char* label, const ImVec2& size_arg, bool selected, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Switcher(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
